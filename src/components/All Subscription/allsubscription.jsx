...
import ss_abi from "../../artifacts/investorage.json";
// import fevm_abi from "../../artifacts/investorage.json"
...
const AllSubscription = () => {
  const CONTRACT_ADDRESS = "0x03879F5a9dF6ca0D20De145b0CaFDf0BDd226877";
  ...
  return (
    ...
    >
      <div className="subs-header">Available Deals</div>
      <div className="subs-imgs-main">
        <div className="subs-imgs1">
          <div className="subs-img-bgs">
            <div className="subs-img-txt">DEAL ID: 67 </div>
            <div className="subs-img-txt">client: t01109 </div>
            <div className="subs-img-txt">provider: t01113 </div>
            <div className="subs-img-txt">start: 25245</div>
            <div className="subs-img-txt">end: 545150</div>
            <div className="subs-img-txt">price_per_epoch: 1100000000000</div>
            <div className="subs-img-txt">client_collateral: </div>
            <div className="subs-img-txt">provider_collateral: </div>
            <button className="subs-img-btn">
              Subscribe
            </button>
          </div>
          <div className="subs-img-bgs">
            <div className="subs-img-txt">DEAL ID: 68 </div>
            <div className="subs-img-txt">client: t01109 </div>
            <div className="subs-img-txt">provider: t01113 </div>
            <div className="subs-img-txt">start: 25245</div>
            <div className="subs-img-txt">end: 545150</div>
          ...
          <div className="subs-img-bgs">
            <div className="subs-img-txt">DEAL ID: 69 </div>
            <div className="subs-img-txt">client: t01109 </div>
            <div className="subs-img-txt">provider: t01113 </div>
            <div className="subs-img-txt">start: 25245</div>
            <div className="subs-img-txt">end: 545150</div>
